...
#import "BPartitionStoreRender.h"
#import "global.h"
#import "ToolConsts.h"
#import "BLMath.h"
#import "DWPartitionStoreGameObject.h"

@implementation BPartitionStoreRender

-(BPartitionStoreRender *) initWithGameObject:(DWGameObject *) aGameObject withData:(NSDictionary *)data
{
    self=(BPartitionStoreRender*)[super initWithGameObject:aGameObject withData:data];
    pogo = (DWPartitionStoreGameObject*)gameObject;
