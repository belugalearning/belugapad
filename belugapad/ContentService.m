...
-(void)adaptPipelineByInsertingWithTriggerData:(NSDictionary*)triggerData
{
    ...
    NSArray *previousInserters=[self getInsertersUsedForProblemId:p._id inEpisodeId:episodeId];
    ...
    if(useThisInserter)
    {
        ...
        [usersService.usersDatabase executeUpdate:@"INSERT INTO EpisodeProblems (id, episode_index, episode_id, episodeinserts_id, problem_id, dvar_data) VALUES (?, ?, ?, ?, ?, NULL)", epid, insertIndex, episodeId, episodeInsertId, p._id];
...
//        [usersService.usersDatabase executeUpdate:@"INSERT INTO EpisodeInserts (id, episode_id, inserter_type, trigger_data, decision_data) VALUES (?, ?, ?, ?, ?)", episodeInsertId, episodeId, useThisInserter.inserterName, [triggerData JSONString],[allDecisionsData JSONString]];
        ...
        [usersService.usersDatabase executeUpdate:@"INSERT INTO EpisodeInserts (id, episode_id, source_problem_id, inserter_type, trigger_data, decision_data) VALUES (?, ?, ?, ?, ?, ?)", episodeInsertId, episodeId, p._id, useThisInserter.inserterName, [triggerData JSONString],[allDecisionsData JSONString]];
