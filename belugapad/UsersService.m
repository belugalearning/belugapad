...
{    
    ...
    [rs close];
    [allUsersDatabase close];
    return users; // TODO: find out what's wrong with the following (attempt to case-insensitively users) [users sortedArrayUsingSelector:@selector(localizedCaseInsensitiveCompare:)];
}
